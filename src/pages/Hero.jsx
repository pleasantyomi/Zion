    ...
    return ( 
        <div className="relative grid gap-6 pb-[4rem]">
            ...
            <div className="lg:pt-[15rem] pt-[6rem]">
                <h1 className="grid text-center leading-none lg:w-9/12 w-11/12 ml-auto mr-auto">
            ...
            <div>
                <p className="text-center text-gray-600 lg:w-7/12 w-10/12 ml-auto mr-auto text-base lg:text-lg">We are a Spirit-filled body of believers who have covenanted themselves together with God to accept and obey the teachings of Christ and His apostles.</p>
            </div>
