        ...
        <div>
            <div className="grid laptop:grid-cols-3 grid-cols-1 w-full mb-0">
                <div className="bg-VeryPaleBlue w-full py-10 px-5">
                    <h1 className="text-center font-semibold text-blue-900 text-[2rem]">Sunday service</h1>
                ...
                <div className="bg-white w-full py-10 px-5">
                    <h1 className="text-center font-semibold text-gray-600 text-[2rem]">Midweek service</h1>
                ...
                <div className="bg-VeryPaleBlue w-full py-10 px-5">
                    <h1 className="text-center font-semibold text-blue-900 text-[2rem]">Powernight service</h1>
