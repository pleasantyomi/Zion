        ...
        <div className="lg:flex grid w-10/12 ml-auto mr-auto">
            ...
            <div className="lg:flex  gap-4 grid pt-10">
                <div className="w-full">
                    ...
                    <h1 className="font-secondary text-xl font-bold mt-3 mb-4">Place Of Heaven</h1>
                ...
                <div className="w-full">
                    <div className="relative bg-blue-900 w-14 h-14 rounded-full">
                        <svg className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 text-white " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
